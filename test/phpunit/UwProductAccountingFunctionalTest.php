...
/**
 * \file    test/functional/UwProductAccountingFunctionalTest.php
...
/**
 * Class UwProductAccountingFunctionalTest
 *
 ...
 *
 * @package Testuwproductaccounting
 */
class UwProductAccountingFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modUwProductAccounting')->click();
		} else {
			// Disable the module
			$this->byHref('modUwProductAccounting')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/uwproductaccounting/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('uwproductaccounting/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/uwproductaccounting/admin/about.php');
		$this->authenticate();
		return $this->assertContains('uwproductaccounting/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('uwproductaccountingwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modUwProductAccounting_UwProductAccountingTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modUwProductAccounting_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
